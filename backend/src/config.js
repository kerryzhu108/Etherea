...
async function createTables() {
    ...
    await client.query(`CREATE TABLE IF NOT EXISTS themes(
                ...
                INSERT INTO themes ${themeColumns} VALUES ('Climate Change', 2, 'CO2 reduced', to_date('2021-10-01','yyyy-mm-dd'), '#A0E3B2');
                INSERT INTO themes ${themeColumns} VALUES ('Mental Health', 5, 'Positive points', to_date('2021-11-01','yyyy-mm-dd'), '#7AD7E0');
                INSERT INTO themes ${themeColumns} VALUES ('Animal Cruelty', 3, 'Animals saved', to_date('2021-12-01','yyyy-mm-dd'), '#F296B8');
                INSERT INTO themes ${themeColumns} VALUES ('Social Justice', 4, 'Social Impact', to_date('2022-01-01','yyyy-mm-dd'), '#F2BD7C');
                `,
        (err, result) => {
            if (err) {
